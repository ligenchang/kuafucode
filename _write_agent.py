"""One-time helper: writes the refactored core/agent.py."""
import pathlib

CONTENT = r'''"""nvagent Agent class — orchestrates a full agentic coding session.
...
pathlib.Path("core/agent.py").write_text(CONTENT)
print(f"Written {len(CONTENT)} chars to core/agent.py")
